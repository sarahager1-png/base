...
import {
  ...
  Printer, Settings, Heart, LogOut, X, Bell, ChevronRight, Sparkles, HelpCircle, BarChart2, Files
} from 'lucide-react';
...
const NAV_COLORS = {
  ...
  'file-management':  { from: '#0ea5e9', to: '#0284c7' },
...
export default function Sidebar({ activeView, setView, user, isOpen, closeSidebar, onLogout, onUserGenderChange }) {
  ...
  const menuItems = [
    ...
    { id: 'schedule',            label: 'לוח זמנים',        icon: Calendar,   roles: ['teacher', 'admin', 'vice_principal', 'secretary', 'assistant', 'counselor', 'coordinator', 'substitute', 'user'] },
    { id: 'tasks',               label: 'משימות ואישורים',  icon: CheckSquare, roles: ['all'] },
    { id: 'attendance',          label: 'היעדרויות ודיווח', icon: Clock,      roles: ['teacher', 'admin', 'vice_principal', 'secretary', 'assistant', 'substitute', 'counselor', 'coordinator', 'user'] },
    ...
    { id: 'printing',            label: 'מרכז צילומים',     icon: Printer,    roles: ['secretary', 'teacher', 'assistant', 'vice_principal', 'counselor', 'coordinator', 'substitute', 'user'] },
    { id: 'maintenance',         label: 'תפעול ורכש',       icon: Settings,   roles: ['admin', 'vice_principal', 'secretary', 'maintenance', 'teacher', 'counselor', 'coordinator', 'assistant', 'user'] },
    ...
    { id: 'file-management',     label: 'ניהול קבצים',      icon: Files,      roles: ['all'] },
