...
export default function StatCard({ title, value, icon: Icon, color, subtext, trend }) {
  ...
  return (
    <div
      className="relative bg-white rounded-2xl p-6 overflow-hidden group cursor-default
    ...
    >
      ...
      {trend !== undefined && (
        <div className="relative mt-4 pt-3 border-t border-slate-100 flex items-center gap-1">
